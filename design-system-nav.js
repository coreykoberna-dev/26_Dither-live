      ...
      groups: [
        {
          ...
          items: [
            ...
            ["Button states", "#component-actions-button-state-matrix"],
            ["Toolbar", "#component-actions-toolbar"],
            ["Feedback", "#component-communication-dialog"],
            ["Tooltips", "#component-communication-tooltip-state-matrix"],
            ["Notifications", "#component-communication-notification-center"],
            ["Containers", "#component-containment-card"],
            ["Popover", "#component-containment-popover"],
            ["Split view", "#component-containment-split-view"],
            ["Navigation", "#component-navigation-top-app-bar"],
            ["Command", "#component-navigation-command-palette"],
            ["Menus", "#component-navigation-context-menu"],
            ["Selection", "#component-selection-checkbox"],
            ["Outline", "#component-selection-tree-and-outline-view"],
            ["Fields", "#component-inputs-text-field"],
            ["Token input", "#component-inputs-tokenized-input"],
          ],
        },
        {
          title: "Account",
          items: [
            ...
            ["Passkey", "#component-auth-passkey-prompt"],
            ...
            ["Privacy", "#component-account-privacy-controls"],
            ["API keys", "#component-account-api-key-manager"],
        ...
        },
        {
          ...
          items: [
            ...
            ["Licenses", "#component-store-license-comparison"],
            ["Payment", "#component-billing-payment-method-form"],
            ["Invoices", "#component-billing-invoice-list"],
            ["Proration", "#component-billing-proration-preview"],
            ["Dunning", "#component-billing-dunning-timeline"],
        ...
        },
        {
          ...
          items: [
            ...
            ["Presets", "#component-workflows-preset-browser"],
            ["Parameters", "#component-workflows-parameter-rack"],
            ["Manifest", "#component-workflows-export-manifest"],
          ],
        },
      ],
    },
